...
const val helpPDF = "https://github.com/Joy-of-Postfix/calculator/blob/main/JoyOfPostfix.pdf"
...
const val ctget   = "get"
const val ctput   = "put"
const val ctsubstring = "substring"
...
class JoyVM {
    ...
    var idsubstring = newidentfunc(ctsubstring,::fsubstring)
